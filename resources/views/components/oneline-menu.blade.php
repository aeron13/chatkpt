<div x-bind:class="`flex gap-4 rounded-[4px] px-2 transition ${ showMenu && 'bg-white' } `" x-data="{ showMenu: false }" @close-oneline-menu.window="showMenu = false" >
    <ul class="flex" x-show="showMenu" x-transition.opacity>
        {{ $slot }}
    </ul>
