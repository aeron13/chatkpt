<form x-data="searchForm" @submit.prevent="handleSubmit" class="flex gap-1 items-stretch">
    <input 
        ...
        x-model="query" 
        placeholder="search" 
        class="font-sans bg-transparent border dark:border-light text-light w-full text-[14px] px-[8px] py-[3px] focus:outline-none rounded-tl-[10px] rounded-tr-[10px] rounded-bl-[10px] rounded-br-[3px] placeholder:font-light" 
        />
