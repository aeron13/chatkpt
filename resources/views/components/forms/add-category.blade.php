...
<form x-data="addCategoryForm" @submit.prevent="handleSubmit" @update-id.window="updateId($event.detail)" @update-data.window="updateData()" @reset-data.window="resetData()" @toggle-category.window="toggleCategory($event.detail)">
