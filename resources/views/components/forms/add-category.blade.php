...
<form x-data="addCategoryForm" @submit.prevent="handleSubmit" x-bind:conv="id" @update-id.window="updateData($event.detail)" @toggle-category.window="toggleCategory($event.detail)">
