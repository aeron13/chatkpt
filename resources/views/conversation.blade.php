<x-app-layout>
    <div class="mx-[15px] lg:mx-[35px] grid grid-cols-12 pt-[170px] lg:pt-[162px]">
        @include('partials/sidebar')
        <div class="col-span-12 lg:col-start-4 lg:col-end-12 pb-[100px]" x-data="conversation" >
            <div class="mx-2 mb-[90px] lg:mb-[29px]">
                ...
                <template x-if="post.categories">
                    <div class="font-sans text-light text-base mt-4">
                        <p>In: 
